...
void marker_detection_thread(CPURender* cpu_buffers, ArucoMarker2d* marker2d_all_cams, ArucoMarker3d* marker3d, CameraParams* cameras_params, CameraCalibResults* calib_results, CameraControl *camera_control, int num_cameras)
{
