...
g++ -Ofast -ffast-math -std=c++17 targets2/*.o \
    -o targets2/orange_client -I ./src/ src/orange_headless_client.cpp src/network_base.cpp src/FFmpegWriter.cpp src/camera_driver_helper.cpp src/camera.cpp src/video_capture.cpp src/offthreadmachine.cpp src/opengldisplay.cpp src/threadworker.cpp src/gpu_video_encoder.cpp \
