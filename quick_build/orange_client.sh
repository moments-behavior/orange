...
g++ -Ofast -ffast-math -std=c++17 $targets_folder/kernel.o \
    -o $targets_folder/orange_client -I ./src/ src/orange_headless_client.cpp src/network_base.cpp src/FFmpegWriter.cpp src/camera.cpp src/video_capture.cpp src/offthreadmachine.cpp src/acquire_frames_headless.cpp src/threadworker.cpp src/gpu_video_encoder.cpp src/global.cpp \
