...
{
public:
    COpenGLDisplay(const char* name, CameraParams *camera_params, CameraEachSelect *camera_select, unsigned char *display_buffer, INDIGOSignalBuilder* indigo_signal_builder, DetectionData* detection_data); // name is the thread name
    ~COpenGLDisplay ();
