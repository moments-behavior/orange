...
{
public:
    COpenGLDisplay(const char* name, CameraParams *camera_params, CameraEachSelect *camera_select, unsigned char *display_buffer, CBOTSignalBuilder* cbot_signal_builder); // name is the thread name
    ~COpenGLDisplay ();
